...
function App() {
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "WebApp Lab", description: "Week 2 Lab B", deadline: "No Rush", done: false, priority: "Low"  },
      { id: 5, title: "Project Proposal", description: "Android App", deadline: "November", done: false, priority: "Low"  },
    ]
  })
